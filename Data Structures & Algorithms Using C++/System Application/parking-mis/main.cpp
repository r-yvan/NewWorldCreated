...
// Data Structures & Algorithms Project Using C++
//
// Build : g++ main.cpp -o PARKING-MIS
// Run   : ./PARKING-MIS
//
...
static void reportsMenu(ParkingSystem& sys)
{
  while (true)
  {
    ...
    switch (c)
    {
    case 1: sys.reportAvailableSlots();
      break;
    case 2: sys.reportParkedVehicles();
      break;
    case 3: sys.reportHistory();
      break;
    case 4: sys.reportDailyRevenue();
      break;
    case 0: return;
    }
  }
